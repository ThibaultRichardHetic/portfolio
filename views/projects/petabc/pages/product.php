...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="../styles/scss/product/style--product.min.css"/>
    ...
    <div class="wrapper">
      <div class="wrapper__header">
        <img src="../images/logo.png" alt="logo">
          ...
          <a class="wrapper__header__a" href="story.php">STORY</a>
          <a  class="wrapper__header__a" href="#">PRODUCT</a>
      ...
      <div class="models__container--grid">
        <aside class="models__aside">
          <div class="aside__colorBack">
            <img class="models__img" src="../images/productPage/distributeurBlack.png" alt="black pet feeder">
    ...
    <section class="faq">
      ...
      <div class="faq__container">
        <article>
          ...
          <img src="../images/productPage/bulle.png" alt="comic strip bubble icon" class="bulle1">
          <img src="../images/productPage/bulle2.png" alt="comic strip bubble icon" class="bulle2">
        </article>
        <article>
