...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../styles/scss/style--generalStyles.min.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="../styles/scss/main/style--header_footer.min.css"/>
    <link rel="stylesheet" type="text/css" media="screen" href="../styles/scss/story/style--story.min.css" />
...
<body>
    ...
    <div class="wrapper">
      <div class="wrapper__header">
        <img src="../images/logo.png" alt="logo">
          ...
          <a class="wrapper__header__a" href="#">STORY</a>
          <a  class="wrapper__header__a" href="product.php">PRODUCT</a>
      ...
      <section class="timeline">
        ...
        <div class="timeline__bar">
          ...
          <article data-aos="slide-right">
             ...
             <img src="../images/timeline/product/product__2.png" alt="second product"/>
             <img src="../images/timeline/logo/logo__1.png" alt="first logo"/>
          </article>
          <article data-aos="slide-right">
             <h3>2017</h3>
             <div class="under_date"></div>
             ...
             <img src="../images/timeline/product/product__3.png" alt="third product"/>
             <h4>November</h4>
             <p>Third prototypes</p>
             <h4>December</h4>
             <p>TPatent registered</p>
             <img src="../images/timeline/logo/logo__2.png" alt="second logo"/>
          </article>
          <article data-aos="slide-right">
             <h3>2018</h3>
             <div class="under_date"></div>
             <p>PetABC iTreater</p>
             <img src="../images/timeline/logo/logo__3.png" alt="third logo"/>
          </article>
        </div>
      </section>
      <section class="presentationTeam">
        ...
        <div class="team">
          <div class="block__imgprofils">
            <img class="block__imgprofils__img" src="../images/story/profils/id1.png" alt="team member">
            ...
            <div class="block__imgprofils">
              <img class="block__imgprofils__img" src="../images/story/profils/id2.png" alt="team member">
              <div class="block__imgprofils__p">
                <p>Jahye Jung</p>
            ...
            <div class="block__imgprofils">
              <img class="block__imgprofils__img" src="../images/story/profils/id3.png" alt="team member">
              <div class="block__imgprofils__p">
                <p>Dahun Jung</p>
                <p>Senior Researcher</p>
              </div>
            ...
            <div class="block__imgprofils">
              <img class="block__imgprofils__img" src="../images/story/profils/id4.png" alt="team member">
              <div class="block__imgprofils__p">
                <p>David C. Chong</p>
            ...
            <div class="block__imgprofils">
              <img class="block__imgprofils__img" src="../images/story/profils/id5.png" alt="team member">
              <div class="block__imgprofils__p">
                <p>Jihun Shim</p>
                <p>Researcher</p>
              </div>
            ...
            <div class="block__imgprofils">
              <img class="block__imgprofils__img" src="../images/story/profils/id6.png" alt="team member">
              <div class="block__imgprofils__p">
                <p>Sunjae Her</p>
                <p>Web designer</p>
              </div>
            ...
            <div class="block__imgprofils">
              <img class="block__imgprofils__img" src="../images/story/profils/id7.png" alt="team member">
              <div class="block__imgprofils__p">
                <p>Heeju Maeng</p>
                <p>Marketing</p>
              </div>
    ...
    <div id="wrapper" class="wrapper">
      ...
      <div id="wrapper__medias" class="wrapper__medias">
        <a class="facebookIcon" href="https://www.facebook.com/pages/category/Shopping---Retail/Pet-Alone-But-Connected-i-Treater-1875845302709565/" target="_blank">
          <img src="../images/icon-social/icon-facebook.svg" alt="facebookIcon">
        </a>
        <a class="instagramIcon" href="https://www.instagram.com/petabc_itreater/" target="_blank">
          <img src="../images/icon-social/icon-instagram.svg" alt="instagramIcon">
        </a>
      </div>
  ...
  <script type="text/javascript"  src="../scripts/aos.min.js"></script>
  <script>
  AOS.init();
  </script>
</body>
