...
<html lang="fr">
  ...
  <body>
    ...
    <main>
      ...
      <div class="rules">
        <div class="col4">
          1 - Le joueur doit taper les mots qui apparaissent à l’écran sans faire d’erreurs.
        </div>
        <div class="col4">
          2 - Si le mot arrive à atteindre le joueur, il perdra la partie.
        </div>
        <div class="col4">
          3 -  Le joueur peut avoir des combos s’il arrive  à faire correctement deux mots sans faire d’erreurs. Cela multiplie le score par 1,5 et pour chaque mots correctement écrits par la suite, 0,5 viendront s’ajouter au compteur.
        </div>
        <div class="col4">
          4 - Lorsque le joueur se trompe d’une lettre il perdra son combo.
        </div>
      </div>
    ...
    <footer>
      ...
      <span><a href="#">Réseaux sociaux</a></span>
      <span>© Agence de développement - TOUS DROITS RÉSERVÉS</span>
      <span>CGV - MENTIONS LEGALES</span>    
    </footer>
