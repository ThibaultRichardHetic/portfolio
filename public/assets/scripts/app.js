...
class Wave {
  ...
  wave() {
    this.$span_title[this.index].classList =
      "title--wave title--wave-effect js-wave";
    this.index++;
  }
}
...
class ImgProjectHover {
  constructor() {
    ...
    this.$projectIllu[4].addEventListener("mouseover", () => {
      this.mouseIn(4);
    });
    this.$projectIllu[5].addEventListener("mouseover", () => {
      this.mouseIn(5);
    });
    this.$projectIllu[6].addEventListener("mouseover", () => {
      this.mouseIn(6);
    });
    ...
    this.$projectIllu[4].addEventListener("mouseout", () => {
      this.mouseOut(4);
    });
    this.$projectIllu[5].addEventListener("mouseout", () => {
      this.mouseOut(5);
    });
    this.$projectIllu[6].addEventListener("mouseout", () => {
      this.mouseOut(6);
    });
  }
